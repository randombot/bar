			...
			if (paused) {
				...
				if (this.resumeFromTeachingAndTicket.justReleased(screenX, screenY)){
					if(hasOffer){
						...
						Gdx.input.getTextInput(this, "Has ganado!\nCanjea tu c�digo para recibir\ntu recompensa.", "C�digo");
					}
				}
	...
	public void input(String cod) {
		if(hasTicket){
			...
			if(cod.equals(COD)){
				...
				Gdx.input.getTextInput(this, "Introduce un c�digo correcto.", "Nuevo c�digo.");
			}
		}
	}
